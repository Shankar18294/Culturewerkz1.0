...
public class TestOrganizationOkr1 extends BaseTest {
	
	@Test(dataProvider = "signIn")
	public void peopleWiseOrgReport(String userName, String password) throws IOException
	{
		/*Check whether or not user is able to navigate to the people wise organization report page*/
	    ...
	    boolean result = okr.assertMessege();
