...
public class TestWorkflow extends BaseTest {
	...
	public void search(String search1) {
		...
		wait.until(ExpectedConditions
				.visibilityOfElementLocated(By.xpath("/html/body/div[2]/div[1]/div[2]/div/form/div/div/ul/li[2]")));
		home.autoSearch();
	...
	public void addKeyResult() throws IOException {
		...
		WebDriverWait wait = new WebDriverWait(driver, 30);
		wait.until(ExpectedConditions
				.visibilityOfElementLocated(By.xpath("/html/body/div[4]/div[2]/div[1]/div[1]/div[1]/div/div[2]")));
