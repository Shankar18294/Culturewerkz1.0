...
public class TestOrganizationOkr3 extends BaseTest {
	
	@Test(dataProvider = "signIn")
	public void organizationWiseKeyResult(String userName, String password) throws IOException
	{
		/*Check whether or not user is able to navigate to the ORGANIZATION-WISE KEY RESULTS page*/
	    ...
	    okr.clickKeyResult(driver);
	    //WebDriverWait wait2 = new WebDriverWait(driver, 30);
	    wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("/html/body/div[4]/div[1]/div[1]/div")));
	   boolean result = okr.displayedKeyResults();
